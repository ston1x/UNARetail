...
public class Scanner extends QtActivity
{

    public static native void fileSelected( String fileName );
    public static native void cameraResponce( String fileName );
    public static native void fileSelected2( String fileName );
    public static native void cameraResponce2( String fileName );
    ...
    protected void onActivityResult( int requestCode , int resultCode , Intent data )
    {
        ...
        else if ( resultCode == RESULT_CANCELED &&  requestCode == REQUEST_IMAGE_CAPTURE)
        {
            ...
            cameraResponce2( "Camera picture canceled" );
